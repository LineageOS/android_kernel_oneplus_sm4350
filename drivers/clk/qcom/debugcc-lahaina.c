...
static const char *const cam_cc_debug_mux_parent_names[] = {
	...
	"cam_cc_sbi_axi_clk",
	"cam_cc_sbi_clk",
	"cam_cc_sbi_cphy_rx_0_clk",
	"cam_cc_sbi_cphy_rx_1_clk",
	"cam_cc_sbi_csid_0_clk",
	"cam_cc_sbi_csid_1_clk",
	"cam_cc_sbi_ife_0_clk",
	"cam_cc_sbi_ife_1_clk",
	"cam_cc_sbi_ife_2_clk",
	"cam_cc_sleep_clk",
};
...
static int cam_cc_debug_mux_sels[] = {
	...
	0x4A,		/* cam_cc_sbi_clk */
	0x4C,		/* cam_cc_sbi_cphy_rx_0_clk */
	0x56,		/* cam_cc_sbi_cphy_rx_1_clk */
	0x4B,		/* cam_cc_sbi_csid_0_clk */
	0x57,		/* cam_cc_sbi_csid_1_clk */
	0x4F,		/* cam_cc_sbi_ife_0_clk */
	0x50,		/* cam_cc_sbi_ife_1_clk */
	0x55,		/* cam_cc_sbi_ife_2_clk */
...
static int gcc_debug_mux_sels[] = {
	0xE8,		/* apss_cc_debug_mux */
	0x4D,		/* cam_cc_debug_mux */
	0x5,		/* core_bi_pll_test_se */
	0x53,		/* disp_cc_debug_mux */
	0x138,		/* gcc_aggre_noc_pcie_0_axi_clk */
	0x139,		/* gcc_aggre_noc_pcie_1_axi_clk */
	0x34,		/* gcc_aggre_noc_pcie_tbu_clk */
	0x13D,		/* gcc_aggre_ufs_card_axi_clk */
	0x13C,		/* gcc_aggre_ufs_phy_axi_clk */
	0x13A,		/* gcc_aggre_usb3_prim_axi_clk */
	0x13B,		/* gcc_aggre_usb3_sec_axi_clk */
	0xA8,		/* gcc_boot_rom_ahb_clk */
	0x47,		/* gcc_camera_ahb_clk */
	0x4A,		/* gcc_camera_hf_axi_clk */
	...
	0xF2,		/* gcc_gp2_clk */
	0xF3,		/* gcc_gp3_clk */
	0x151,		/* gcc_gpu_cfg_ahb_clk */
	0x158,		/* gcc_gpu_gpll0_clk_src */
	0x159,		/* gcc_gpu_gpll0_div_clk_src */
	0x154,		/* gcc_gpu_memnoc_gfx_clk */
	0x157,		/* gcc_gpu_snoc_dvm_gfx_clk */
	0xFA,		/* gcc_pcie0_phy_rchng_clk */
	0x103,		/* gcc_pcie1_phy_rchng_clk */
	...
	0x101,		/* gcc_pcie_1_aux_clk */
	0x100,		/* gcc_pcie_1_cfg_ahb_clk */
	0xFF,		/* gcc_pcie_1_mstr_axi_clk */
	0x102,		/* gcc_pcie_1_pipe_clk */
	0xFE,		/* gcc_pcie_1_slv_axi_clk */
	0xFD,		/* gcc_pcie_1_slv_q2a_axi_clk */
	0x9E,		/* gcc_pdm2_clk */
	...
	0x89,		/* gcc_qupv3_wrap0_core_2x_clk */
	0x88,		/* gcc_qupv3_wrap0_core_clk */
	0x8A,		/* gcc_qupv3_wrap0_s0_clk */
	0x8B,		/* gcc_qupv3_wrap0_s1_clk */
	0x8C,		/* gcc_qupv3_wrap0_s2_clk */
	0x8D,		/* gcc_qupv3_wrap0_s3_clk */
	0x8E,		/* gcc_qupv3_wrap0_s4_clk */
	0x8F,		/* gcc_qupv3_wrap0_s5_clk */
	0x90,		/* gcc_qupv3_wrap0_s6_clk */
	0x91,		/* gcc_qupv3_wrap0_s7_clk */
	...
	0x170,		/* gcc_qupv3_wrap2_s1_clk */
	0x171,		/* gcc_qupv3_wrap2_s2_clk */
	0x172,		/* gcc_qupv3_wrap2_s3_clk */
	0x173,		/* gcc_qupv3_wrap2_s4_clk */
	...
	0x6D,		/* gcc_usb30_prim_master_clk */
	0x6F,		/* gcc_usb30_prim_mock_utmi_clk */
	0x6E,		/* gcc_usb30_prim_sleep_clk */
	0x76,		/* gcc_usb30_sec_master_clk */
	0x78,		/* gcc_usb30_sec_mock_utmi_clk */
	0x77,		/* gcc_usb30_sec_sleep_clk */
	0x70,		/* gcc_usb3_prim_phy_aux_clk */
	0x71,		/* gcc_usb3_prim_phy_com_aux_clk */
	0x72,		/* gcc_usb3_prim_phy_pipe_clk */
	0x79,		/* gcc_usb3_sec_phy_aux_clk */
	0x7A,		/* gcc_usb3_sec_phy_com_aux_clk */
	0x7B,		/* gcc_usb3_sec_phy_pipe_clk */
	0x54,		/* gcc_video_ahb_clk */
	0x57,		/* gcc_video_axi0_clk */
	0x58,		/* gcc_video_axi1_clk */
	0x59,		/* gcc_video_xo_clk */
	0x153,		/* gpu_cc_debug_mux */
...
static int gpu_cc_debug_mux_sels[] = {
	...
	0x16,		/* gpu_cc_cx_apb_clk */
	0x1A,		/* gpu_cc_cx_gmu_clk */
	0x14,		/* gpu_cc_cx_qdss_at_clk */
	0x19,		/* gpu_cc_cx_qdss_trig_clk */
	0x15,		/* gpu_cc_cx_qdss_tsctr_clk */
	0x17,		/* gpu_cc_cx_snoc_dvm_clk */
	0xB,		/* gpu_cc_cxo_aon_clk */
	0x1B,		/* gpu_cc_cxo_clk */
	0xC,		/* gpu_cc_freq_measure_clk */
	0x11,		/* gpu_cc_gx_gmu_clk */
	0xF,		/* gpu_cc_gx_qdss_tsctr_clk */
...
static struct clk_hw *debugcc_lahaina_hws[] = {
...
static int clk_debug_lahaina_probe(struct platform_device *pdev)
{
	struct clk *clk;
	int ret = 0, i;
	...
	for (i = 0; i < ARRAY_SIZE(debugcc_lahaina_hws); i++) {
		clk = devm_clk_register(&pdev->dev, debugcc_lahaina_hws[i]);
		if (IS_ERR(clk)) {
			dev_err(&pdev->dev, "Unable to register %s, err:(%d)\n",
				clk_hw_get_name(debugcc_lahaina_hws[i]),
				PTR_ERR(clk));
			return PTR_ERR(clk);
		}
	}
...
static struct platform_driver clk_debug_driver = {
	.probe = clk_debug_lahaina_probe,
	.driver = {
		.name = "debugcc-lahaina",
		.of_match_table = clk_debug_match_table,
	},
};

static int __init clk_debug_lahaina_init(void)
{
	return platform_driver_register(&clk_debug_driver);
}
fs_initcall(clk_debug_lahaina_init);

MODULE_DESCRIPTION("QTI DEBUG CC LAHAINA Driver");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("platform:debugcc-lahaina");
